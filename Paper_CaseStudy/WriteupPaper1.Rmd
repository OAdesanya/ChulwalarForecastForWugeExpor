...
summary(Model_ses)
png(filename ="ExponentialSmoothing.png")
plot(Model_ses)
#AIC     AICc      BIC       RMSE
...
summary(Model_hw_2)
png(filename ="hw_2.png")
plot(Model_hw_2)
#AIC     AICc      BIC       RMSE
#1910.516 1920.407 1946.942  54484.25

png(filename ="AddictivevsMultiplicative.png")
...
png(filename ="UrbanoExports.png")
...
png(filename ="GlobalisationPartyMembers.png")
...
png(filename ="NationalHolidays.png")
...
png(filename ="ChulwalarIndex.png")
...
png(filename ="IndependenceDayPresents.png")
...
png(filename ="InfluenceNationalHolidays.png")
